...
def votingPg(root,frame1,client_socket):
    ...
    Radiobutton(frame1, text = "CCC\n\nNelsom Chamisa", variable = vote, value = "bjp", indicator = 0, height = 4, width=15, command = lambda: voteCast(root,frame1,"bjp",client_socket)).grid(row = 2,column = 1)
    ...
    Radiobutton(frame1, text = "Congress\n\nED Pfee", variable = vote, value = "cong", indicator = 0, height = 4, width=15, command = lambda: voteCast(root,frame1,"cong",client_socket)).grid(row = 3,column = 1)
    ...
    Radiobutton(frame1, text = "MDC\n\nDouglas Mwonzora", variable = vote, value = "aap", indicator = 0, height = 4, width=15, command = lambda: voteCast(root,frame1,"aap",client_socket) ).grid(row = 4,column = 1)
    ...
    Radiobutton(frame1, text = "ZAPU\n\nKanos", variable = vote, value = "ss", indicator = 0, height = 4, width=15, command = lambda: voteCast(root,frame1,"ss",client_socket)).grid(row = 5,column = 1)
